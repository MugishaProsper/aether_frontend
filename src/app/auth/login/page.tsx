              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => setFormData({ email: "buyer@demo.com", password: "demo123" })}
                  >
                    <Badge variant="secondary" className="mr-2 text-xs">Buyer</Badge>
                    Customer
                  </Button>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => setFormData({ email: "seller@demo.com", password: "demo123" })}
                  >
                    <Badge variant="secondary" className="mr-2 text-xs">Seller</Badge>
                    Merchant
                  </Button>
                </div>
              </div>
